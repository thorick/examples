 ...
 *
 */
public class PriorityQueue_BST_Balanced_test
        extends PriorityQueue_base_test
{

  private Logger log =
          Logger.getLogger(PriorityQueue_BST_Balanced_test.class);


  protected PriorityQ<String> getPriorityQueue() {
    return new PriorityQueue_BST_Balanced();
  }
  ...
  public void basicTest() {
    String m = "basicTest: ";
    PriorityQ<String> q = new PriorityQueue_BST_Balanced();
