...
public class InternetRoutingSimulation {
                ...
                switch (message.messageType) {
                    ...
                    case SINGLE_NODE_CALCULATIONS_COMPLETE:
                        ...
                        if (!SourceRoundLeaderNodePCElement.isRoundComplete()) {
                            ...
                            proto(this, message, "NODE(" + netNodeNumber + ")  isRoundComplete() == false  exit, allow other concurrent Node Calculations to complete.");
                            break;
                        }
                        ...
                        int nextRoundChildNodeSentCount = 0;
                            ...
                            if (it.hasNext()) {
                                ...
                                if (nextSourceRoundLeader != null) {
                                    ...
                                    for (Integer i : nextRoundLeaderPCElement.childNodes) {
                                        // kick off all previously unprocessed nodes
                                    ...
                                    if (nextRoundChildNodeSentCount > 0) {
                                        break;
                                    }
                                }
                            }
    ...
    public static void runDemo0() {
        ...
        if (debug_protocol != null) { prog.DEBUG_PROTOCOL = true; }
