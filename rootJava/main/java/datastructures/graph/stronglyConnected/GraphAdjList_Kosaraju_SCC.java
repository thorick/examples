 ...
 *
 */
public class GraphAdjList_Kosaraju_SCC extends
        GraphAdjList implements Graph {

  private Logger log =
          Logger.getLogger(GraphAdjList_Kosaraju_SCC.class);


  public GraphAdjList_Kosaraju_SCC(int sizeLimit, boolean isDigraph) {
  ...
  public synchronized GraphAdjList_Kosaraju_SCC reverse() {
    if (!isDigraph) {
      return this;
    }
    GraphAdjList_Kosaraju_SCC rev = newGraph(sizeLimit, isDigraph);
  ...
  public synchronized  GraphAdjList_Kosaraju_SCC copy() {
    int size = adj.length;
    GraphAdjList_Kosaraju_SCC copy = newGraph(size, isDigraph);
  ...
  protected GraphAdjList_Kosaraju_SCC newGraph(int size, boolean isDigraph) {
    return new GraphAdjList_Kosaraju_SCC(size, isDigraph);
  }
